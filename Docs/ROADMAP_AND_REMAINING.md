...
The newest follow-up validates Native party transfers and keeps the actor's
...
Next audit work: **player-speaker tag cleanup, active leader context and join/start timing**,
